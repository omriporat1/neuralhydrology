...
**Seven-entry checkpoint-selection manifest — populated and frozen (local only).** `.scratch_local/devpop_audit_a5/devpop_audit_selection_manifest_v001.json`: file SHA-256 `4ce75f1e7fb74becf765ab59e17ffdaea44f2dd5f71cf827468e87388b9ac1a0`, internal order-independent `manifest_sha256` `3b1a471164d6d85dd0071f45c069f9c5619ad89e3f4fafc269a8fb23ae19b9f9`. The committed `load_devpop_audit_selection_manifest` validator passes: exactly seven entries; composition Bayesian {1,2,3} + random-control {1,2,3,4}; no duplicate trial/config identities; per-entry frozen screening score, `screening_best_epoch`, `checkpoint_filename`, and `checkpoint_sha256` present and grammar-cross-checked. Not transferred to or materialized on Moriah in this session.
